...
```
gcc zlib_devel binutils libtool gawk make bison flex grep sed tar autoconf automake gettext bash file wget openssl coreutils cmd:gfortran cmd:dos2unix
```
